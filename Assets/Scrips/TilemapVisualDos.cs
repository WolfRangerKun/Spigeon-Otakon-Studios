...
public class TilemapVisualDos : MonoBehaviour
{
    //[System.Serializable]
    ...
    //private GridDos<Tilemap.TilemapObject> grid;
    //private Mesh mesh;
    ...
    //public void SetGrid(GridDos<Tilemap.TilemapObject> grid)
    //{
    //    this.grid = grid;
    //    UpdateHeatMapVisual();
    ...
    //private void Grid_OnGridValueChanged(object sender, GridDos<Tilemap.TilemapObject>.OnGridObjectChangedEventArgs e)
    //{
    //    updateMesh = true;
    //}
